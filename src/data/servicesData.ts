...
export const servicesData: ServiceDetail[] = [
  {
    ...
    benefits: [
      ...
      { title: "Apoio Contínuo", description: "Após a publicação do website, mantemos uma manutenção técnica para que nada falhe." },
    ],
    process: [
      ...
      { title: "Lançamento", description: "Publicamos online e damos apoio à manutenção." },
    ],
    faq: [
      {
