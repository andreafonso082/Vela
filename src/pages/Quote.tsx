...
const Quote = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Orçamento Gratuito | Agência de Marketing Algarve | Empresa de Websites</title>
        <meta name="description" content="Peça o seu orçamento gratuito à Agência Vela: Agência de Marketing no Algarve em Tavira. Websites Algarve, SEO e Redes Sociais desde 700€." />
        <link rel="canonical" href={`${appUrl}/quote`} />
        <meta property="og:title" content="Orçamento Gratuito | Agência de Marketing Algarve | Empresa de Websites" />
        <meta property="og:description" content="Solicite um orçamento para marketing digital e criação de websites no Algarve. Empresa que faz sites com orçamentos grátis em 24h." />
        <meta property="og:url" content={`${appUrl}/quote`} />
        <meta property="og:image" content={`${appUrl}/og-image.png`} />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:image" content={`${appUrl}/og-image.png`} />
        <meta name="keywords" content="agência de marketing, agência de marketing algarve, agência de marketing no algarve, websites algarve, empresa de websites, empresa que faz sites, empresa de sites, marketing algarve, orçamento websites algarve, orçamento marketing digital" />
      </Helmet>
