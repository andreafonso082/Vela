...
const Contact = () => {
  ...
  return <div className="min-h-screen">
      <Helmet>
        <title>Contacto | Agência de Marketing Algarve | Empresa de Websites</title>
        <meta name="description" content="Entre em contacto com a Agência Vela: Agência de Marketing no Algarve em Tavira. Peça o seu orçamento para websites Algarve e marketing digital. Resposta em 24h." />
        <link rel="canonical" href={`${appUrl}/contact`} />
        <meta property="og:title" content="Contacto | Agência de Marketing Algarve | Empresa de Websites" />
        <meta property="og:description" content="Contacte a melhor agência de marketing algarve para criação de websites e SEO. Orçamentos grátis e sem compromisso." />
        <meta property="og:url" content={`${appUrl}/contact`} />
        <meta property="og:image" content={`${appUrl}/og-image.png`} />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:image" content={`${appUrl}/og-image.png`} />
        <meta name="keywords" content="agência de marketing, agência de marketing algarve, agência de marketing no algarve, websites algarve, empresa de websites, empresa que faz sites, empresa de sites, marketing algarve, contacto marketing tavira, falar com agência vela" />
      </Helmet>
