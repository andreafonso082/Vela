...
const About = () => {
  ...
  return <div className="min-h-screen">
      <Helmet>
        <title>Sobre Nós | Agência de Marketing Algarve e Empresa de Websites</title>
        <meta name="description" content="Saiba mais sobre a Agência Vela: Agência de Marketing no Algarve líder em criação de websites e marketing digital para PMEs com preços transparentes." />
        <link rel="canonical" href={`${appUrl}/about`} />
        <meta property="og:title" content="Sobre Nós | Agência de Marketing Algarve e Empresa de Websites" />
        <meta property="og:description" content="Especialistas em Marketing Digital no Algarve. Empresa de websites e web design em Tavira focada em resultados reais." />
        <meta property="og:url" content={`${appUrl}/about`} />
        <meta property="og:image" content={`${appUrl}/og-image.png`} />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:image" content={`${appUrl}/og-image.png`} />
        <meta name="keywords" content="agência de marketing, agência de marketing algarve, agência de marketing no algarve, websites algarve, empresa de websites, empresa que faz sites, empresa de sites, marketing algarve, sobre a agência vela, marketing digital portugal" />
      </Helmet>
